  ...
  return (
    <section className="container w-full mx-auto">
      ...
      <section className="cards-container mt-[5.3rem] sm:mt-[6.7rem] md:mt-[7.2rem] mx-auto flex flex-col gap-0 px-2">
        ...
        <ul className="w-full mx-auto grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] sm:grid-cols-[repeat(auto-fit,minmax(250px,1fr))] md:grid-cols-[repeat(auto-fit,minmax(250px,1fr))] lg:grid-cols-[repeat(auto-fit,minmax(250px,1fr))] justify-center gap-3">
          {
            posts?.length > 0 ? (
